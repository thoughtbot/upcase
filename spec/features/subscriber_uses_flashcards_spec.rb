...
feature "Subscriber views decks" do
  ...
  scenario "and saves it to their review queue" do
    ...
    expect(deck.last_attempted_by(last_flashcard_attempt.user)).to eq(last_flashcard_attempt.created_at)
  end
  ...
  context "and completes the deck" do
    ...
    scenario "after marking a flashcard as needing review" do
      ...
      within(".decks-area") do
        expect(page).to have_content(last_attempted_at(last_flashcard_attempt.created_at))
      end
    end
  end
