shared_examples 'a class inheriting from Product' do
  ...
  describe 'with a discount' do
    it 'returns a discounted individual price' do
      product = create_product(individual_price: 50)
    ...
    it 'returns a discounted company price' do
      product = create_product(company_price: 50)
    ...
    it 'reports that the product is discounted' do
      product = create_product(discount_percentage: 20)
      product.should be_discounted
    end
  end

  it 'reports that it is not discounted' do
    product = create_product(discount_percentage: 0)
