def adwords_conversion_tracker(value)
  <<-JS.strip_heredoc
    ...
    <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/983769411/?value=#{value}&amp;label=h6fpCI3R6QkQw8KM1QM&amp;guid=ON&amp;script=0"/>
    </div>
    </noscript>
    JS
end
