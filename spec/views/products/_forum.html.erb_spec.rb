...
describe 'products/_forum_link.html.erb' do
  context 'when the user has a subscription' do
    it 'includes a link to the forum' do
      render partial: 'products/forum_link.html.erb', locals: { current_user: user_with_subscription }
  ...
  context 'when the user does not have a subscription' do
    it 'does not include a link to the forum' do
      render partial: 'products/forum_link.html.erb', locals: { current_user: user_without_subscription }
