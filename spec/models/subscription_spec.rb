...
describe Subscription do
  ...
  describe '#has_access_to?' do
    context 'when the subscription is inactive' do
      it 'returns false' do
        ...
        expect(subscription.has_access_to?("workshops")).to be false
      end
    end
    ...
    context 'when subscription is active and includes feature' do
      it "returns true" do
        ...
        expect(subscription.has_access_to?("workshops")).to be true
      end
    end
  end
  ...
  describe '#team?' do
    it 'returns true with a team' do
      ...
      expect(subscription.team?).to be true
    end

    it 'returns false without a team' do
      subscription = build_stubbed(:subscription)

      expect(subscription.team?).to be false
    end
  end
