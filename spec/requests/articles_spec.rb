...
describe 'Articles' do
  context 'index' do
    ...
    it 'links external articles and indicates subscription articles' do
      ...
      expect(page).not_to have_css("#article_#{tumblr_article.id}", text: I18n.t('shared.subscriptions.icon'))
      expect(page).to have_css("#article_#{article.id}", text: I18n.t('shared.subscriptions.icon'))
    end
  end
