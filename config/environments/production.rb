...
Rails.application.configure do
  ...
  # config/master.key, or an environment key such as
  # config/credentials/production.key.
  # This key is used to decrypt credentials (and other encrypted files).
  # config.require_master_key = true

  # Disable serving static files from `public/` by default, relying on
  # NGINX/Apache to do so instead.
  ...
  # config.active_job.queue_name_prefix = "upcase_production"
