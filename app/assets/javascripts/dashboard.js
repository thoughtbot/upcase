$(function() {
  if ($('.card-slider').length) {
    ...
    // slide the slider by moving the first card around via margin if the
    // card is in mid-transition, wait until it finishes to add the margin,
    // so that the margin remains divisible by one card width
